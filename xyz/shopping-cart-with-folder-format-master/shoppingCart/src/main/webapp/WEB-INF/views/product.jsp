...
<form:form action="product_add" commandName="product" method="post" enctype="multipart/form-data">
	...
	<c:choose>
		...
		<td><form:input class="form-control" type="text" path="id" name="id" disabled="true" readonly="true"/></td>
		</c:when>
		<c:otherwise>
		<td><form:input class="form-control" type="text" path="id" name="id" maxlength="20"/></td>
		</c:otherwise>
		</c:choose>
		</tr>
	...
	<tr>
		...
		<td>Product Name</td>
		<td><form:input class="form-control" type="text" path="name" name="name" maxlength="50" /></td>
	</tr>		
		
	<tr>
		<td>Product Price</td>
		<td><form:input class="form-control" type="text" path="price" name="price" maxlength="5" /></td>
	</tr>
	
	<tr>
		<td>Product Description</td>
		<td><form:input class="form-control" type="text" path="desc" name="desc" maxlength="100" /></td>
	</tr>
	...
	<tr>
		<td>Product Image</td>
		<td><form:input class="form-control" type="file" path="image" name="image"/></td>
	</tr>
	
	<tr>
	<td>
		<c:if test="${!empty product.name }">
		<input  class="form-control" type="submit" value="<spring:message text="Edit Product"/>"/> 
		</c:if> 

		<c:if test="${empty product.name }"> 
 			<input class="btn btn-success" type="submit" value="<spring:message text="Add Product"/>"/> 
		</c:if> 
		</td>
	</tr>
