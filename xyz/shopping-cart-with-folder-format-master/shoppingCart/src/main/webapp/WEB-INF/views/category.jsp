...
<form:label style="color:#000000" path="id"><spring:message text="ID"/></form:label>
		<c:choose>
			<c:when test="${!empty category.id }">
				<form:input class="form-control"  path="id" disabled="true" readonly="true"/>
			</c:when>
			<c:otherwise>
				<form:input class="form-control"  path="id"  pattern=".{4,7}" required="true" title="id should be between 4 to 7 characters"/>
				</c:otherwise>
				</c:choose>
     <br><br>
    ...
    <form:label style="text-align:center;" path="name"><spring:message text="NAME"/></form:label>
    <form:input class="form-control" type="text" name="name" path="name"/><br>
    
    <br><br>
    
    <form:label style="color:#000000" path="des"><spring:message text="DESCRIPTION"/></form:label>
    <form:input class="form-control" type="text" name="des" path="des"/><br>
